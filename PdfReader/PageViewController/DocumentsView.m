...
- (void)viewDidLoad
{
    ...
    //[popoverController presentPopoverFromRect:CGRectMake(100, 100, 300, 400) inView:self.rotatingFooterView permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
